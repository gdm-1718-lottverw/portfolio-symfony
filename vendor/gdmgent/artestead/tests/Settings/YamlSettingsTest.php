...
class YamlSettingsTest extends TestCase
{
    ...
    {
        $settings = YamlSettings::fromFile(__DIR__.'/../../resources/Artestead.yaml');
    ...
    public function it_can_be_saved_to_a_file()
    {
        ...
        $filename = self::$testDirectory.DIRECTORY_SEPARATOR.'Artestead.yaml';
    ...
    public function it_can_configure_its_sites()
    {
        $settings = new YamlSettings([
            'sites' => [
                [
                    'map' => 'artestead.local',
                    'to' => '/home/vagrant/Code/artestead-local/laravel/public',
                    'type' => 'laravel',
                    'schedule' => true,
                ],
            ],
        ...
        $this->assertEquals([
            'map' => 'test.com.local',
            'to' => '/home/vagrant/Code/test-com/laravel/public',
            'type' => 'laravel',
            'schedule' => true,
        ], $attributes['sites'][0]);
    }
