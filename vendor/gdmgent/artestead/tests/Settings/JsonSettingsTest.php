...
class JsonSettingsTest extends TestCase
{
    ...
    {
        $settings = JsonSettings::fromFile(__DIR__.'/../../resources/Artestead.json');
    ...
    public function it_can_be_saved_to_a_file()
    {
        ...
        $filename = self::$testDirectory.DIRECTORY_SEPARATOR.'Artestead.json';
    ...
    public function it_can_configure_its_sites()
    {
        $settings = new JsonSettings([
            'sites' => [
                [
                    'map' => 'artestead.local',
                    'to' => '/home/vagrant/Code/artestead/laravel/public',
                    'type' => 'laravel',
                    'schedule' => true,
                ],
            ],
